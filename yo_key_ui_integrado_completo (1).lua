...
local function BuildRecoveredMainHub()
    ...
    local function buildTheme()
        ...
        return {
            ...
            ControlAlt = Color3.fromRGB(45, 45, 45),
            ControlRaised = Color3.fromRGB(25, 25, 25),
    ...
    HubTitle.Font = Enum.Font.ArimoBold
    ...
    MinButton.Size = UDim2.new(0, 24, 0, 24)
     ...
     MinButton.Font = Enum.Font.ArimoBold
    ...
    PlayerNameLabel.Font = Enum.Font.ArimoBold
            ...
            local function CreatePage(titleText, subtitleText)
                ...
                function pageApi:AddSection(side, sectionTitle)
                    local column = side == "right" and right or left
                     ...
                     sectionTitleLabel.Font = Enum.Font.ArimoBold
                    ...
                    function section:AddToggle(toggleTitle, default, callback)
                        ...
                        switchBg.BackgroundColor3 = state and Theme.Accent or Color3.fromRGB(45, 45, 45)
                        ...
                        row.MouseLeave:Connect(function()
                            if not uiAnimEnabled() then return end
                            if not state then
                                tweenUI(switchBg, 0.18, Enum.EasingStyle.Quad, Enum.EasingDirection.Out, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)})
                            end
                        end)
                        ...
                        row.MouseButton1Click:Connect(function()
                            ...
                            tweenUI(switchBg, 0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out, {BackgroundColor3 = state and Theme.Accent or Color3.fromRGB(45, 45, 45)})
                    ...
                    function section:AddCredit(avatar, username, role)
                        ...
                        userLabel.Font = Enum.Font.ArimoBold
